...
var CLIENT_ID = '313786596738-4aod6eue9luqpd6jkf0s2v4kplbisaos.apps.googleusercontent.com';
var API_KEY = 'AIzaSyBedqo5qEirgk7Go8y0sjILzRfctei5aII';
var FOLDER_NAME = "";
var FOLDER_ID = "root";
...
$(function(){
	 ...
	 $("#fUpload").bind("change", function () {
		...
		try{
			var uploader =new MediaUploader({
				file: file,
				token: gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token,//gapi.auth.getToken().access_token,
				metadata: metadata,
	...
	$("#btnAddFolder").click(function () {
        if ($("#txtFolder").val() == "") {
			...
			var access_token =  gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token;//gapi.auth.getToken().access_token;
...
function initDriveButtons(){
    ...
    $(".button-text").click(function () {
		...
		var accessToken = gapi.auth2.getAuthInstance().currentUser.get().getAuthResponse().access_token;// gapi.auth.getToken().access_token;
